...
async function mainAsyncLocal() {
  ...
  async function buildPopupDisplayData(state) {
    ...
    const [issueTypeCapability, priorityCapability, assigneeCapability, transitionOptions, sprintCapability, affectsCapability, fixVersionsCapability, labelsCapability, environmentCapability, labelSuggestionSupport, customFieldChips] = await Promise.all([
